...
<body>
    ...
    <form class="custom-form" runat="server" method="post">
        ...
        <asp:Button CssClass="btn btn-default btn-block submit-button" id="button1" Text="Finish" runat="server" OnClick="registerAccount" />
    </form>
</div>
    </div>
